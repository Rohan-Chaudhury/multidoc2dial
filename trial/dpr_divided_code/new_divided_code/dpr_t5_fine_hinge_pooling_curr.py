...
del checkpoint_ce
print ("\n Model loaded successfully and checkpoint deleted! \n ")
...
preprocessed_data = preprocess_data(training_data, negative_weight=0, hard_negative_weight=1)


preprocessed_validation_data = preprocess_data(validation_data, negative_weight=0, hard_negative_weight=1)
...
print ("\n\n New Flan Datasets loaded curriculum learning and hard negatives\n\n")
