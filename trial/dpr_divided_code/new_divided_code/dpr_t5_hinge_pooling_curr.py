...
preprocessed_data = preprocess_data(training_data, negative_weight=1, hard_negative_weight=0)


preprocessed_validation_data = preprocess_data(validation_data, negative_weight=1, hard_negative_weight=0)
print ("\n New Flan Datasets - whole full with new batch size with no hard negative----\n")
...
print ("\n\n New Flan Datasets loaded curriculum learning\n\n")
