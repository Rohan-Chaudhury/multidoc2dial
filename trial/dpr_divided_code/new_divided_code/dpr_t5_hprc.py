...
checkpoint_path_ce =  "../t5_large_500/2023-05-03_12-06-33/ce_checkpoint.pth"
...
def train_dpr_model(config, train_dataset, validation_dataset, cross_encoder, t5_tokenizer, device):
    ...
    for epoch in range(epochs):
        ...
        directory_to_save_train="./output/train/t5_large_500/"+timestamp
        ...
        if avg_val_loss < best_val_loss:
            ...
            # Get the current date and time as a string
            timestamp = datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
            directory_to_save="./output/t5_large_500/"+timestamp
            # Create a new directory with the timestamp
