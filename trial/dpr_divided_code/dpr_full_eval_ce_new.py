...
class T5CrossEncoder(nn.Module):
    ...
    def _init_classifier(self, d_model):
        classifier = nn.Linear(2*d_model, 1)  
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # Apply max pooling
        max_pooled_output, _ = torch.max(last_hidden_state, dim=1)

        # Concatenate pooled outputs
        pooled_output = torch.cat((mean_pooled_output, max_pooled_output), dim=-1)
...
# checkpoint_path_dpr = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/output/models/19_loss/dpr_checkpoint.pth"
...
# checkpoint_path_dpr = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/output/models/best_model/dpr_checkpoint.pth"
...
# checkpoint_path_dpr = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/output/models/after_66/dpr_checkpoint.pth"

# checkpoint_path_ce = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/new_divided_code/output/t5_large_500/2023-05-23_08-17-44/ce_checkpoint.pth"

# checkpoint_path_ce = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/new_divided_code/output/t5_large_500/2023-05-25_18-28-23/ce_checkpoint.pth"

# checkpoint_path_ce= "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/new_divided_code/output/train/t5_large_500/2023-05-27_03-44-30/ce_checkpoint.pth"

#
# checkpoint_path_ce = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/new_divided_code/output/t5_large_500/2023-05-31_18-35-51/ce_checkpoint.pth"
checkpoint_path_ce = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/new_divided_code/output/t5_large_500/2023-06-03_18-43-20/ce_checkpoint.pth"
...
def load_saved_model(checkpoint_path_dpr, checkpoint_path_ce):
    ...
    print ("DPR Loss: ", checkpoint_dpr["loss"])
...
def encode_questions(train_dataset, batch_size=256):
    encoded_questions = []
    max_length = 512
...
def encode_context(corpus_dataset, batch_size=256):
    encoded_contexts = []
    max_length = 512
