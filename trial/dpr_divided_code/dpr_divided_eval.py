...
checkpoint_path_dpr = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/output/contr_disr_ran_resid_pre/2023-04-26_22-50-41/dpr_checkpoint.pth"
checkpoint_path_ce = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/output/t5_large_ce/2023-04-22_11-02-22/ce_checkpoint.pth"
...
def load_saved_model(checkpoint_path_dpr, checkpoint_path_ce):
    ...
    combined_model.load_state_dict(checkpoint_dpr['model_state_dict'])
...
def evaluate(model, cross_encoder, question_tokenizer, context_tokenizer, t5_tokenizer, data_loader, device):
    ...
    for idx,item in enumerate(tqdm(data_loader)):
        with torch.no_grad():
                ...
                t5_question = truncate_question_sequences(question, 200)
                ...
                t5_input = [f"{t5_question} </s> {p}" for p in top_k_passages]
