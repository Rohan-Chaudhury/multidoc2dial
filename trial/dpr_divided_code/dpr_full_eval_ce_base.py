...
checkpoint_path_ce = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/scp_trial/dpr/soft_ce/t5_base_new/ce_checkpoint.pth"
...
def encode_questions(train_dataset, batch_size=256*5):
    encoded_questions = []
    max_length = 512
...
def encode_context(corpus_dataset, batch_size=256*5):
    encoded_contexts = []
    max_length = 512
