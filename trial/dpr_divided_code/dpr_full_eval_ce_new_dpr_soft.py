...
checkpoint_path_ce = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/scp_trial/dpr/hprc_ce/2023-06-14_20-24-47/ce_checkpoint.pth"
...
top_10_indices_cosine = search_faiss(question_embeddings, index, k=50)
import pickle
...
recall_50 = recall_at_k(top_10_indices_cosine, positive_psg_ids, 50)
...
print ("Reranked with cross encoder with initial count of 50")
...
# Search using cosine similarity to find the top 10 most similar context embeddings
top_10_indices_cosine = search_faiss(question_embeddings, index, k=40)
import pickle
...
print ("Reranked with cross encoder with initial count of 40")
print(f"Recall@1 (Cosine): {recall_1_cosine:.4f}")
print(f"Recall@5 (Cosine): {recall_5_cosine:.4f}")
print(f"Recall@10 (Cosine): {recall_10_cosine:.4f}")
...
# Search using cosine similarity to find the top 10 most similar context embeddings
top_10_indices_cosine = search_faiss(question_embeddings, index, k=30)
import pickle
...
print ("Reranked with cross encoder with initial count of 30")
print(f"Recall@1 (Cosine): {recall_1_cosine:.4f}")
print(f"Recall@5 (Cosine): {recall_5_cosine:.4f}")
print(f"Recall@10 (Cosine): {recall_10_cosine:.4f}")
...
# Search using cosine similarity to find the top 10 most similar context embeddings
top_10_indices_cosine = search_faiss(question_embeddings, index, k=20)
import pickle
...
print ("Reranked with cross encoder with initial count of 20")
print(f"Recall@1 (Cosine): {recall_1_cosine:.4f}")
print(f"Recall@5 (Cosine): {recall_5_cosine:.4f}")
print(f"Recall@10 (Cosine): {recall_10_cosine:.4f}")
...
# Search using cosine similarity to find the top 10 most similar context embeddings
top_10_indices_cosine = search_faiss(question_embeddings, index, k=10)
import pickle
...
print ("Reranked with cross encoder with initial count of 10")
print(f"Recall@1 (Cosine): {recall_1_cosine:.4f}")
print(f"Recall@5 (Cosine): {recall_5_cosine:.4f}")
print(f"Recall@10 (Cosine): {recall_10_cosine:.4f}")
