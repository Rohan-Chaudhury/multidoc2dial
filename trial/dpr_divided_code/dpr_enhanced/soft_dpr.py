...
with open("/home/softlab/Documents/md2d_trial/enhanced_dpr/new_dpr/enhanced_dpr/training_psg_data.json", "r") as f:
...
with open("/home/softlab/Documents/md2d_trial/enhanced_dpr/new_dpr/enhanced_dpr/validation_psg_data.json", "r") as f:
...
print ("Doing data processing now newly! \n")
...
def validate_dpr_model(config, validation_dataset, cross_encoder, t5_tokenizer, device, best_val_loss):
    ...
    if avg_val_loss < best_val_loss:
        ...
        directory_to_save="/home/softlab/Documents/md2d_trial/enhanced_dpr/valid/"+timestamp
...
def train_dpr_model(config, train_dataset, validation_dataset, cross_encoder, t5_tokenizer, device):
    ...
    print ("Let's see what happens now now now 11\n")
    max_length = config["max_length"]
    ...
    for epoch in range(epochs):
        cross_encoder.train()
        print ("Cross encoder is in training mode now 2\n")
