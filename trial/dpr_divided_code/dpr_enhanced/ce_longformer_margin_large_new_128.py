...
tokenizer = LongformerTokenizerFast.from_pretrained('allenai/longformer-large-4096', max_length = MAX_SEQ_LEN)
...
def preprocess_question(question):
    question = truncate_question_sequences(question, tokenizer, max_question_len=128)
...
print ("Final New 128 2 new deleted questions Training the model now margin 4090 new large new eval fixed gradient 32--- \n")
# Train the model
trainer.train()
