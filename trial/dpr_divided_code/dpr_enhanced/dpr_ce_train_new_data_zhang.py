...
class T5CrossEncoder(nn.Module):
    def __init__(self, pretrained_model_name, model_max_length, dropout_rate=0.2, position_dropout=0.2):
        super().__init__()
        ...
        self.attention = nn.MultiheadAttention(config.d_model, num_heads=16, dropout=0.2)
...
with open("/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/dpr_enhanced/zhang/Zhang/dpr.multidoc2dial_all.structure.train.json", "r") as f:
...
with open("/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/dpr_enhanced/zhang/Zhang/dpr.multidoc2dial_all.structure.validation.json", "r") as f:
...
print ("Doing data processing now newly in new new--! \n")
