...
checkpoint_path_ce = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/dpr_enhanced/valid/2023-08-06_19-17-43_17.3/ce_checkpoint.pth"

print ("Checkpoint path: ", checkpoint_path_dpr)
print ("new Checkpoint path 1024: ", checkpoint_path_ce)
...
def return_cross_encoder(checkpoint_path_ce):
...
def rerank_with_cross_encoder(t5_questions, top_10_indices, context_passages, cross_encoder, tokenizer, k=10, batch_size=10):
    max_length = 1024
...
t5_questions = [truncate_question_sequences(question,max_question_len=256) for question in train_dataset["question"]]

del combined_model

t5_cross_encoder = return_cross_encoder(checkpoint_path_ce)
