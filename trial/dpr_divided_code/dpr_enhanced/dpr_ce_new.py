...
class T5CrossEncoder(nn.Module):
    def __init__(self, pretrained_model_name, model_max_length, dropout_rate=0.2, fine_tune=True):
        super().__init__()
...
# class T5CrossEncoder(nn.Module):
#     def __init__(self, pretrained_model_name, model_max_length, dropout_rate=0.1, fine_tune=True):
#         super().__init__()
#         config = T5Config.from_pretrained(pretrained_model_name)
#         config.model_max_length = model_max_length
#         self.t5 = T5EncoderModel.from_pretrained(pretrained_model_name, config=config)
...
#             nn.Sigmoid(),
#         )
#         nn.init.kaiming_normal_(classifier[0].weight, nonlinearity='relu')
#         return classifier
...
# class T5CrossEncoder(nn.Module):
#     def __init__(self, pretrained_model_name, model_max_length, dropout_rate=0.1, fine_tune=False, trainable_layers=2):
#         super().__init__()
#         config = T5Config.from_pretrained(pretrained_model_name)
#         config.model_max_length = model_max_length
#         self.t5 = T5EncoderModel.from_pretrained(pretrained_model_name, config=config)
...
# class T5CrossEncoder(nn.Module):
#     def __init__(self, pretrained_model_name, model_max_length, dropout_rate=0.1, fine_tune=False, trainable_layers=1):
#         super().__init__()
#         config = T5Config.from_pretrained(pretrained_model_name)
#         config.model_max_length = model_max_length
#         self.t5 = T5EncoderModel.from_pretrained(pretrained_model_name, config=config)
...
preprocessed_data = preprocess_data(training_data, negative_weight=20)
