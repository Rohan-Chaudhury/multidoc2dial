...
class T5CrossEncoder(nn.Module):
    def __init__(self, pretrained_model_name, model_max_length, dropout_rate=0.1, position_dropout=0.2):
        super().__init__()
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # attention_output = self.layer_norm(attention_output)  # residual connection and LayerNorm
...
print ("Doing data processing now newly now pos 1024 with lookahead new new new 2 2 2 2 dropout--! \n")
