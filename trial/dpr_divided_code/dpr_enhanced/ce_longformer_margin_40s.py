...
with open(r"C:\Users\softi\Projects\multidoc2dial\Zhang\enhanced_dpr\training_psg_data.json", "r") as f:
    training_data = json.load(f)

with open(r"C:\Users\softi\Projects\multidoc2dial\Zhang\enhanced_dpr\validation_psg_data.json", "r") as f:
...
print ("New Training the model now margin 4090 new--- \n")
# Train the model
trainer.train()
