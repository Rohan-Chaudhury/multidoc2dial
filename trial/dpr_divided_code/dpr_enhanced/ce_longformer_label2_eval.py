...
cross_encoder_path = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/dpr_enhanced/longformer_models/weighted_loss/checkpoint-14747"
...
def rerank_with_cross_encoder(cross_questions, top_10_indices, context_passages, cross_model, cross_tokenizer, k=10, batch_size=8):
    cross_model.eval()
    max_length = 1024
