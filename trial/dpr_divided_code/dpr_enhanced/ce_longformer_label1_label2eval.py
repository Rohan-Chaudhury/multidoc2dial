...
top_10_indices = search_faiss(question_embeddings, index, k=80)
...
recall_80 = recall_at_k(top_10_indices, positive_psg_ids, 80)

print(f"Recall@1: {recall_1:.4f}")
print(f"Recall@5: {recall_5:.4f}")
print(f"Recall@10: {recall_10:.4f}")
print(f"Recall@80: {recall_80:.4f}")
...
# top_10_indices_cosine = search_cosine_similarity(question_embeddings, context_embeddings, k=80)
...
recall_80 = recall_at_k(top_10_indices_cosine, positive_psg_ids, 80)
...
cross_encoder_path = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/dpr_enhanced/longformer_models/margin_loss/checkpoint-18769"
...
cross_encoder_path = "/home/grads/r/rohan.chaudhury/multidoc2dial/multidoc2dial/trial/dpr_divided_code/dpr_enhanced/results_normal_loss_function/checkpoint-7374"
print ("Cross encoder path: ", cross_encoder_path)
